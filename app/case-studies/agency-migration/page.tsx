...
export const metadata: Metadata = {
  title:
    "Agency Migration Case Study: Legacy to Headless Next.js + AWS | Stryxon",
  description:
    "Detailed case study of migrating a digital agency from slow Magento/WordPress infrastructure to modern Headless Next.js + AWS architecture. 95+ Lighthouse score, 40% cost reduction, 70% faster page loads.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "How we migrated a digital agency from legacy infrastructure to modern Headless Next.js + AWS architecture with dramatic performance and cost improvements.",
...
export default function CaseStudyPage() {
  const jsonLd = {
    ...
    "@type": "Article",
    headline:
      "Agency Migration Case Study: Legacy Infrastructure to Headless Next.js + AWS",
    description:
      "Detailed technical case study documenting the migration of a digital agency from Magento/WordPress to modern Headless Next.js + AWS architecture",
    author: {
      "@type": "Organization",
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-indigo-400 via-purple-400 to-pink-400 bg-clip-text text-transparent">
              Legacy to Modern: <br />
              Agency Infrastructure Migration
            </h1>
            <p className="text-xl text-gray-300 leading-relaxed">
              How we migrated a digital agency from legacy Magento/WordPress
              infrastructure to Headless Next.js + AWS architecture, achieving
              95+ Lighthouse scores and 40% cost reduction.
            </p>
          </div>
              ...
              <div className="grid md:grid-cols-3 gap-8">
                <div>
                  ...
                  <p className="text-gray-400 text-sm">
                    From 42/100 to 98/100 performance score
                  </p>
                </div>
                <div>
                  <div className="flex items-center gap-3 mb-3">
                  ...
                  <p className="text-gray-400 text-sm">
                    $2,847/mo to $1,680/mo infrastructure
                  </p>
                </div>
                <div>
                  <div className="flex items-center gap-3 mb-3">
                  ...
                  <p className="text-gray-400 text-sm">
                    6.8s to 1.4s Largest Contentful Paint
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  ...
                  <p className="text-gray-300 mb-4">
                    A mid-sized digital agency managing 25+ client websites was
                    struggling with legacy infrastructure:
                  </p>
                  <ul className="space-y-2">
                    <li className="flex items-start gap-3 text-gray-400">
                      <XCircle className="w-5 h-5 text-red-400 flex-shrink-0 mt-1" />
                      <span>
                        Magento 2.x e-commerce platform with severe performance
                        issues
                      </span>
                    </li>
                    <li className="flex items-start gap-3 text-gray-400">
                      <XCircle className="w-5 h-5 text-red-400 flex-shrink-0 mt-1" />
                      <span>
                        WordPress multisite for content, requiring constant
                        security updates
                      </span>
                    </li>
                    <li className="flex items-start gap-3 text-gray-400">
                      <XCircle className="w-5 h-5 text-red-400 flex-shrink-0 mt-1" />
                      <span>
                        Traditional VPS hosting with manual scaling and frequent
                        downtime
                      </span>
                    </li>
                    <li className="flex items-start gap-3 text-gray-400">
                      <XCircle className="w-5 h-5 text-red-400 flex-shrink-0 mt-1" />
                      <span>
                        45-minute deployment process with frequent rollback
                        requirements
                      </span>
                    </li>
                  </ul>
                ...
                <div>
                  ...
                  <p className="text-gray-300 mb-4">
                    The legacy infrastructure was directly affecting business
                    outcomes:
                  </p>
                  <ul className="space-y-2">
                    <li className="flex items-start gap-3 text-gray-400">
                      ...
                      <span>
                        Lost 15-20% of e-commerce conversions due to slow page
                        loads
                      </span>
                    </li>
                    <li className="flex items-start gap-3 text-gray-400">
                      <span className="text-red-400 flex-shrink-0 mt-1">→</span>
                      <span>
                        Poor Google rankings from failing Core Web Vitals
                        assessment
                      </span>
                    </li>
                    <li className="flex items-start gap-3 text-gray-400">
                      <span className="text-red-400 flex-shrink-0 mt-1">→</span>
                      <span>
                        High infrastructure costs with unpredictable scaling
                        expenses
                      </span>
                    </li>
                    <li className="flex items-start gap-3 text-gray-400">
                      <span className="text-red-400 flex-shrink-0 mt-1">→</span>
                      <span>
                        Development team spending 40% time on infrastructure
                        maintenance
                      </span>
                    </li>
                  </ul>
          ...
          <section className="mb-20">
            <h2 className="text-3xl font-bold mb-8 text-white">
              Before: Legacy Infrastructure State
            </h2>
            ...
            <div className="mb-8">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
                {beforeMetrics.map((metric) => (
                  <div
                    key={metric.label}
                    className="bg-red-900/10 border border-red-500/30 rounded-lg p-4"
                  >
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-grow">
                    ...
                    <p className="text-gray-300 mb-3">
                      Designed new Headless architecture leveraging AWS
                      services:
                    </p>
                    <ul className="space-y-2 text-sm text-gray-400">
                      <li>
                      ...
                      <li>
                        • <strong>Commerce:</strong> Migrated Magento to Shopify
                        Headless (Storefront API + GraphQL)
                      </li>
                      <li>
                        • <strong>Content:</strong> WordPress headless mode with
                        WPGraphQL API
                      </li>
                      <li>
                        • <strong>Infrastructure:</strong> AWS CloudFront CDN,
                        S3 for assets, Lambda for serverless functions
                      </li>
                      <li>
                        • <strong>Database:</strong> AWS RDS PostgreSQL with
                        automated backups
                      </li>
                    </ul>
                  </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-grow">
                    <h3 className="text-xl font-semibold text-purple-400 mb-3">
                      Data Migration (Weeks 3-5)
                    </h3>
                    <p className="text-gray-300 mb-3">
                      Migrated 7 years of content and commerce data:
                    </p>
                    <ul className="space-y-2 text-sm text-gray-400">
                      <li>
                        • Exported 45,000+ products from Magento with full
                        attributes and variants
                      </li>
                      <li>
                        • Migrated 12,000+ blog posts and pages from WordPress
                      </li>
                      <li>
                        • Preserved SEO metadata, redirects, and URL structures
                      </li>
                      <li>
                        • Imported customer data with GDPR-compliant handling
                      </li>
                      <li>
                        • Created automated sync scripts for ongoing content
                        updates
                      </li>
                    </ul>
                  </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-grow">
                    <h3 className="text-xl font-semibold text-green-400 mb-3">
                      Frontend Development (Weeks 4-8)
                    </h3>
                    <p className="text-gray-300 mb-3">
                      Built modern Next.js frontend with performance
                      optimization:
                    </p>
                    <ul className="space-y-2 text-sm text-gray-400">
                      <li>
                        • Implemented Server-Side Rendering (SSR) for product
                        pages
                      </li>
                      <li>
                        • Static Generation (SSG) for blog content with ISR
                        revalidation
                      </li>
                      <li>
                        • Image optimization with Next.js Image component (WebP,
                        lazy loading)
                      </li>
                      <li>
                        • Code splitting and dynamic imports for 70% bundle size
                        reduction
                      </li>
                      <li>
                        • Implemented React Server Components for zero-JS page
                        sections
                      </li>
                    </ul>
                  </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-grow">
                    <h3 className="text-xl font-semibold text-orange-400 mb-3">
                      Infrastructure Setup (Weeks 6-8)
                    </h3>
                    <p className="text-gray-300 mb-3">
                      Provisioned AWS infrastructure with Infrastructure as
                      Code:
                    </p>
                    <ul className="space-y-2 text-sm text-gray-400">
                      <li>
              ...
              <div className="bg-gradient-to-br from-cyan-900/20 to-blue-900/20 border border-cyan-500/30 rounded-xl p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-grow">
                    ...
                    <p className="text-gray-300 mb-3">
                      Comprehensive testing and gradual traffic migration:
                    </p>
                    <ul className="space-y-2 text-sm text-gray-400">
                      <li>
                        • Load testing with 10,000 concurrent users (passed with
                        99.9% uptime)
                      </li>
                      ...
                      <li>
                        • Emergency rollback plan with instant DNS failover
                      </li>
                    </ul>
                  </div>
                </div>
          ...
          <section className="mb-20">
            <h2 className="text-3xl font-bold mb-8 text-white">
              After: Modern Infrastructure Results
            </h2>
              ...
              <div className="bg-green-900/10 border border-green-500/30 rounded-xl p-8">
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <ul className="space-y-2 text-sm text-gray-400">
                      <li>
                        • Next.js 14 on Vercel Edge Network (global deployment)
                      </li>
                      ...
                      <li>
                        • React Server Components reducing client JS by 70%
                      </li>
                    </ul>
                  </div>
                  <div>
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-400">
                        From improved Core Web Vitals and faster page loads
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-400">
                        Directly attributed to performance improvements
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-400">
                        Google rewarding excellent Core Web Vitals scores
                      </p>
                    </div>
                  </li>
                </ul>
                ...
                <ul className="space-y-3 text-gray-300">
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-400">
                        In 6 months post-migration vs 4-6 incidents/month before
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-400">
                        CI/CD pipeline enabling daily releases
                      </p>
                    </div>
                  </li>
                </ul>
            ...
            <div className="mt-6 bg-gradient-to-r from-indigo-900/20 to-purple-900/20 border border-indigo-500/30 rounded-xl p-8">
              ...
              <div className="grid md:grid-cols-3 gap-6 text-center">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-400">
                    Total Cost Savings & Revenue Gain
                  </div>
                </div>
                <div>
                  <div className="text-3xl font-bold text-green-400 mb-2">
            ...
            <div className="space-y-4">
              <div className="bg-gray-900/50 border border-gray-800 rounded-xl p-6">
                ...
                <p className="text-gray-300">
                  Migrating traffic gradually (10% → 100% over 2 weeks) allowed
                  us to identify and fix edge cases in production without
                  impacting the majority of users. This approach is critical for
              ...
              <div className="bg-gray-900/50 border border-gray-800 rounded-xl p-6">
                ...
                <p className="text-gray-300">
                  Using Terraform for all AWS infrastructure meant we could
                  recreate the entire stack in minutes for testing, disaster
                  recovery, or client replication. This single decision saved
                  hundreds of hours over 6 months.
                </p>
              </div>

              <div className="bg-gray-900/50 border border-gray-800 rounded-xl p-6">
                <h3 className="text-lg font-semibold text-blue-400 mb-3">
                  3. Headless Commerce Requires Backend Strength
                </h3>
                <p className="text-gray-300">
                  While Shopify's Storefront API is excellent, complex product
                  logic and inventory management required custom middleware.
                  Budget 20-30% more time for backend integration than initially
                  estimated.
                </p>
              </div>
              ...
              <div className="bg-gray-900/50 border border-gray-800 rounded-xl p-6">
                ...
                <p className="text-gray-300">
                  Setting up Real User Monitoring (RUM) before launch provided
                  invaluable data for optimization. We caught 3 critical
                  performance regressions that synthetic testing missed.
                </p>
              </div>
            </div>
          </section>
          ...
          <div className="bg-gradient-to-r from-indigo-600/20 to-purple-600/20 border border-indigo-500/30 rounded-2xl p-12 text-center">
            <h2 className="text-3xl font-bold mb-4">
              Ready to Modernize Your Agency Infrastructure?
            </h2>
            <p className="text-gray-300 text-lg mb-8 max-w-3xl mx-auto">
              Stryxon Technologies specializes in white-label infrastructure
              migrations for digital agencies. We handle the technical
              complexity while you focus on client relationships and growth.
            </p>
