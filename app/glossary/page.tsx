...
import { Book, Code, Cloud, Zap, Database, Layers, Cpu, Globe, FileCode, Gauge } from 'lucide-react'

export const metadata: Metadata = {
  title: 'Guide to Modern Agency Infrastructure - Technical Glossary | Stryxon',
  description: 'Comprehensive guide to modern web infrastructure terms for digital agencies. Learn about RAG AI, Headless CMS, Core Web Vitals, Infrastructure as Code, and more technical concepts that drive agency growth.',
  keywords: [
  ...
  openGraph: {
    ...
    description: 'Essential technical terms and concepts for scaling digital agencies with modern web infrastructure.',
...
const glossaryTerms = [
  {
    ...
    content: "RAG AI is an advanced artificial intelligence architecture that combines large language models (LLMs) with external knowledge retrieval systems. For digital agencies, RAG AI enables custom chatbots and support systems that can access your client's specific documentation, product catalogs, and knowledge bases in real-time. Unlike standard AI models with static training data, RAG systems dynamically retrieve relevant information before generating responses, ensuring accurate, up-to-date answers. Agencies implementing RAG AI see 60-80% reduction in customer support costs while improving response accuracy by 95%. This technology is particularly valuable for white-label AI solutions that need to serve multiple clients with distinct knowledge bases without retraining entire models.",
    benefits: [
  ...
  },
  {
    ...
    relatedTerms: ["Core Web Vitals", "Serverless Architecture", "API Development"],
  },
  {
    ...
    relatedTerms: ["Headless Next.js", "Edge Computing", "Serverless Architecture"],
  },
  {
    ...
    relatedTerms: ["Immutable Infrastructure", "DevOps", "Cloud Infrastructure"],
  },
  {
    ...
    relatedTerms: ["Infrastructure as Code", "DevOps", "Serverless Architecture"],
  },
  {
  ...
  },
  {
    ...
    relatedTerms: ["Core Web Vitals", "Serverless Architecture", "Headless Next.js"],
  },
  {
...
export default function GlossaryPage() {
  const jsonLd = {
    ...
    "description": "Comprehensive glossary of technical terms for digital agencies implementing modern web infrastructure",
    "publisher": {
      "@type": "Organization",
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="max-w-4xl mx-auto text-center mb-20">
            ...
            <p className="text-xl text-gray-300 leading-relaxed">
              Essential technical knowledge base for digital agencies scaling with modern web architecture. 
              Understand the infrastructure concepts driving high-performance, white-label solutions.
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto mb-20">
            <div className="bg-gradient-to-br from-indigo-900/20 to-purple-900/20 border border-indigo-500/30 rounded-2xl p-8">
              <h2 className="text-2xl font-bold mb-4 text-indigo-400">Why This Glossary Matters</h2>
              <p className="text-gray-300 mb-4">
                Modern digital agencies face a rapidly evolving technical landscape. Understanding these 10 foundational 
                concepts enables agencies to:
              </p>
              <ul className="space-y-2 text-gray-400">
                <li className="flex items-start gap-3">
                  <span className="text-indigo-400 mt-1">→</span>
                  <span>Reduce infrastructure costs by 40-70% through modern architecture patterns</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-indigo-400 mt-1">→</span>
                  <span>Deliver 3-5x faster websites with measurable Core Web Vitals improvements</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-indigo-400 mt-1">→</span>
                  <span>Scale technical operations without proportional headcount increases</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-indigo-400 mt-1">→</span>
                  <span>Offer competitive white-label services with enterprise-grade architecture</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="max-w-4xl mx-auto mt-20">
            <div className="bg-gradient-to-r from-indigo-600/20 to-purple-600/20 border border-indigo-500/30 rounded-2xl p-12 text-center">
              <h2 className="text-3xl font-bold mb-4">Ready to Implement Modern Infrastructure?</h2>
              <p className="text-gray-300 text-lg mb-8">
                Stryxon Technologies specializes in white-label implementation of these modern architecture patterns. 
                Let us help your agency deliver enterprise-grade solutions without building an in-house infrastructure team.
              </p>
